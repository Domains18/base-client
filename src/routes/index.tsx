...
function TerminalBackground() {
    const [lines, setLines] = useState<Array<{ text: string; id: number; opacity: number }>>([]);
    ...
    useEffect(() => {
        const handleMove = (clientX: number, clientY: number) => {
            ...
            const moveDistance = Math.sqrt(
                Math.pow(newX - initialPosition.x, 2) + Math.pow(newY - initialPosition.y, 2),
            );
            if (moveDistance > 5) {
                setHasMoved(true);
            }
            ...
            <div className="relative min-h-screen flex items-center justify-center px-4 sm:px-6">
                ...
                <div className="relative z-10 text-center max-w-4xl mx-auto">
                    ...
                    <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 mb-8">
                        ...
                        <span className="text-sm text-gray-300">Your Digital Sanctuary</span>
                        <svg
                    ...
                    <p className="text-base sm:text-lg text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed px-4">
                        A secure and centralized hub for your passwords, documents, resumes, and
                        personal utilities. All under your control.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                        ...
                        <button className="btn-ghost px-8 py-3 w-full sm:w-auto">Learn More</button>
                    </div>
                </div>
